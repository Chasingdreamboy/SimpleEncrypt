...
+ (NSString *)encryptString:(NSString *)str publicKey:(NSString *)pubKey{
    ...
    return [EWRSA encryptData:data publicKey:pubKey];
}
...
+ (NSString *)encryptInteger:(NSInteger)integer publicKey:(NSString *)pubKey{
    ...
    return [EWRSA encryptString:str publicKey:pubKey];
}
...
+ (NSString *)encryptData:(NSData *)data publicKey:(NSString *)pubKey{
    ...
    SecKeyRef keyRef = [EWRSA addPublicKey:pubKey];
    if (!keyRef) {
        return nil;
    }
...
//	}
	...
	data = [EWRSA stripPublicKeyHeader:data];
	if(!data){
		return nil;
	}
